...
namespace NAudio4Maui
{
    ...
    //Originally copied from: https://gist.github.com/neilt6/287cc804a42b20f1973c9435ceec2686
    /// <summary>
    ...
    public class AudioOut : IWavePlayer
    {
        ...
        /// <summary>
        /// Releases the unmanaged resources used by the current instance of the <see cref="AudioReader"/> class.
        /// </summary>
        ~AudioOut()
        {
        ...
        /// <summary>
        /// Releases all resources used by the current instance of the <see cref="AudioReader"/> class.
        /// </summary>
        public void Dispose()
        {
            //Dispose of this object
        ...
        /// <summary>
        /// Releases the unmanaged resources used by the <see cref="AudioReader"/>, and optionally releases the managed resources.
        /// </summary>
