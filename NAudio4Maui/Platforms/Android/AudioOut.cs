...
namespace NAudio4Maui
{
    ...
    // Originally copied from: https://gist.github.com/neilt6/6d07322070470536ea0ba409c343c2a5 and supplemented it with the GetPosition method
    /// <summary>
    /// Represents an Android wave player implemented using <see cref="AudioTrack"/>.
    /// </summary>
    public class AudioOut : IWavePlayer
    {
        #region Fields
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="AudioOut"/> class.
        /// </summary>
        public AudioOut()
        {
        ...
        /// <summary>
        /// Releases the unmanaged resources used by the current instance of the <see cref="AudioOut"/> class.
        /// </summary>
        ~AudioOut()
        {
        ...
        /// <summary>
        /// Releases all resources used by the current instance of the <see cref="AudioOut"/> class.
        /// </summary>
        public void Dispose()
        {
            //Dispose of this object
        ...
        /// <summary>
        /// Releases the unmanaged resources used by the <see cref="AudioOut"/>, and optionally releases the managed resources.
        /// </summary>
